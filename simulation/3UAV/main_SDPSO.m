...
for i = 1:it
    ...
    disp(['iteration: ' num2str(i) ' xc1 = ' num2str(xc1(i+1)) ' yc1 = ' num2str(yc1(i+1)) ' xc2 = ' num2str(xc2(i+1)) ' yc2 = ' num2str(yc2(i+1)) ' xc3 = ' num2str(xc3(i+1)) ' yc3 = ' num2str(yc3(i+1))]);
    ...
    % F1
    pun_coeff_1(1,i) = exp(1/(dn1(i)+dn2(i)+dn3(i)));
    F(1, i) = ((dn1(i)*dn1(i)/l1_max) + (dn2(i)*dn2(i)/l2_max) + (dn3(i)*dn3(i)/l3_max)) * pun_coeff_1(1,i);
    F1(i) = F(1,i);

    % F2
    pun_coeff_2(1,i) = 500 * exp(-((d12(i)./d12(1)).^2));
    pun_coeff_3(1,i) = 500 * exp(-((d13(i)./d13(1)).^2));
    pun_coeff_4(1,i) = 500 * exp(-((d23(i)./d23(1)).^2));
    if d12 > ds
        f_collision(1,i) = 0;
    else
    ...
    if ((xg3 - xc3(i+1))^2 + (yg3 - yc3(i+1))^2)^(0.5) <= df
        xc3(i+1) = xg3;
        yc3(i+1) = yg3;
    end
