 function [vxn1, vyn1, vxn2, vyn2, vxn3, vyn3, vxn4, vyn4, vxn5, vyn5] = SDPSO(xc1,yc1,xs1,ys1,xg1,yg1,l1_max,vx1,vy1,h1,h1_old, ...
...
nPop_max=100;    % Population Size (Swarm Size)
nPop_min=50;     % Population Size (Swarm Size)
w=1;             % Inertia Weight
...
T = (sqrt(((xs1-xg1)^2+(ys1-yg1)^2)) + sqrt(((xs2-xg2)^2+(ys2-yg2)^2)) + sqrt(((xs3-xg3)^2+(ys3-yg3)^2)) + ...
    sqrt(((xs4-xg4)^2+(ys4-yg4)^2)) + sqrt(((xs5-xg5)^2+(ys5-yg5)^2)))/(l1_max+l2_max+l3_max+ ...
    l4_max+l5_max); % temperature of current system (T=1)
