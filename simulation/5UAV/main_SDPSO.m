...
w1=0.5;            % relative weight factor of cost funtion 1
w2=0.4;            % relative weight factor of cost funtion 2
w3=0.1;            % relative weight factor of cost funtion 3
...
for i = 1:it
    ...
    % F2
    pun_coeff_2(1,i) = 100 * exp(-((d12(i)./d12(1)).^2));
    pun_coeff_3(1,i) = 100 * exp(-((d13(i)./d13(1)).^2));
    pun_coeff_4(1,i) = 100 * exp(-((d14(i)./d14(1)).^2));
    pun_coeff_5(1,i) = 100 * exp(-((d15(i)./d15(1)).^2));
    pun_coeff_6(1,i) = 100 * exp(-((d23(i)./d23(1)).^2));
    pun_coeff_7(1,i) = 100 * exp(-((d24(i)./d24(1)).^2));
    pun_coeff_8(1,i) = 100 * exp(-((d25(i)./d25(1)).^2));
    pun_coeff_9(1,i) = 100 * exp(-((d34(i)./d34(1)).^2));
    pun_coeff_10(1,i) = 100 * exp(-((d35(i)./d35(1)).^2));
    pun_coeff_11(1,i) = 100 * exp(-((d45(i)./d45(1)).^2));
    ...
    F(2,i) = f_collision(1,i) + f_collision(2,i) + f_collision(3,i) + f_collision(4,i) + f_collision(5,i) + f_collision(6,i) + f_collision(7,i) + f_collision(8,i) + f_collision(9,i) + f_collision(10,i);
    F2(i) = F(2,i);
